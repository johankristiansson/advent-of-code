...
type Command = Sound | SetRegister | Increase | Multiply | Remainder | Recover | Jump;
    ...
    switch (action.type) {
        ...
        case "increase":
            return {
                ...
                register: {
                    ...state.register,
                    [action.register]: (state.register[action.register] || 0) + getValue(action.value, state.register)
                },
                pointer: state.pointer + 1
            };
        case "multiply":
        ...
        case "jump":
            ...
            return jump
                ? {
                    ...state,
                    pointer: state.pointer + (getValue(action.value, state.register) || 1)
                }
                : {
                    ...state,
                    pointer: state.pointer + 1
